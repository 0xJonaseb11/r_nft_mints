...
contract FiredGuys is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function _autorizeUpgrade(address newImplementation) 
    ...
    function supportsInterfaces(bytes4 interfaceId) 
    public view override(ERC721Upgradeable, ERC721StorageUpgradeable)
    returns (bool) {
